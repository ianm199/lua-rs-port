...
-- Slice up to line 237 of pm.lua follows:
-- $Id: testes/pm.lua $
...
print("CHECKPOINT line 218 passed")
_G.a, _G.x = nil
print("CHECKPOINT line 219 passed")
...
print("CHECKPOINT line 227 passed")
...
print("CHECKPOINT line 234 passed")
assert(not isbalanced("(9 ((8) 7) a b (\0 c) a"))
print("CHECKPOINT line 235 passed")
assert(string.gsub("alo 'oi' alo", "%b''", '"') == 'alo " alo')
print("CHECKPOINT line 236 passed")
